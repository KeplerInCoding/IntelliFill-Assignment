...
const Interested = () => {
  return (
    <div className="flex flex-col gap-4 bg-white shadow-md p-6 rounded-md w-[420px]  border-[1.5px] border-gray-200 h-[603px]">
    {interestedExams.map((interestedExams, index) => (
      <div key={index} >
        ...
        <div className="flex items-center text-blue-500 text-[12px] font-semibold">
